...
class SignInPageState extends State<SignInPage> {
  ...
  Widget build(BuildContext context) {
    ...
    logger.d(fp.getUser());
    // print('1:${ fp.getUser() != null && fp.getUser().emailVerified == false }');
    // print('2:${ fp.getUser() }');
    // print('3:${ fp.getUser().emailVerified }');
    return Scaffold(
      key: _scaffoldKey,
  ...
  void _signIn() async {
    ...
    print('1');
    // fp.signInWithEmail(_mailCon.text, _pwCon.text).then((value) => print(value));
