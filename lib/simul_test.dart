...
import 'styles/timwork_styles.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: RawKeyboardListener(
          ...
          child: LayoutBuilder(builder: (context, bodySize) {
                                        ...
                                        child: Column(
                                          children: [
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: TextButton(
                                                        onPressed: () {},
                                                        child: AutoSizeText('토목', style: toggleButtonTextStyle),
                                                      ),
                                                    ),
                                                    Container(
                                                      width: 55,
                                                      child: TextButton(
                                                        onPressed: () {},
                                                        child: AutoSizeText('건축', style: toggleButtonTextStyle),
                                                      ),
                                                    ),
                                                    Container(
                                                      width: 55,
                                                      child: TextButton(
                                                        onPressed: () {},
                                                        child: AutoSizeText('구조', style: toggleButtonTextStyle),
                                                      ),
                                                    ),
                                                    Container(
                                                      width: 55,
                                                      child: TextButton(
                                                        onPressed: () {},
                                                        child: AutoSizeText('설비', style: toggleButtonTextStyle),
                                                      ),
                                                    ),
                                                    Container(
                                                      width: 55,
                                                      child: TextButton(
                                                        onPressed: () {},
                                                        child: AutoSizeText('전기', style: toggleButtonTextStyle),
                                                      ),
                                                    ),
                                                    Container(
                                                      width: 55,
                                                      child: TextButton(
                                                        onPressed: () {},
                                                        child: AutoSizeText('소방', style: toggleButtonTextStyle),
                                                      ),
                                                    ),
                                                  ],
                                                ),
                                            ...
                                            Expanded(
                                              ...
                                              child: ClipRRect(
                                                borderRadius: BorderRadius.circular(20),
                                                child: Container(color: white, child: buildTaskAddWidget(context)),
                                              ),
                                            )),
                                          ],
                                        )),
                                                ...
                                                Row(
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        '${DateFormat('yy.MM.dd').format(day)}',
                                                        textScaleFactor: 1.3,
                                                      ),
                                                    ),
                                                    Expanded(
                                              ...
                                              Row(
                                                children: [
                                                  Padding(
                                                    padding: const EdgeInsets.all(8.0),
                                                    child: Text(
                                                      '${DateFormat('yy.MM.dd').format(day.add(Duration(days: 1)))}',
                                                      textScaleFactor: 1.3,
                                                    ),
                                                  ),
                                                  Expanded(
  ...
  Widget build(BuildContext context) {
    return Stack(
        children: set
            ...
            .where((t) => t.floor == context.watch<CP>().getDrawing().floor)
            .toList()
            .map((e) {
              ...
              List<Offset> parse = data
                  .map((e) => Offset(
                      ...
                      e.dy / (watch.getcordiY() / widget.height) + ((watch.getDrawing().originY * widget.height))))
                  .toList();
                                  ...
                                  child: Material(
                                    child: InkWell(
                                      ...
                                      onTap: () {
                                        print('클릭');
                                        print(
                                            (widget.day.difference(e.start).inDays / e.end.difference(e.start).inDays));
                                        Get.defaultDialog(
                                            title: e.name,
                                                ...
                                                children: [
                                                  ...
                                                  ExpansionTile(
                                                    ...
                                                    children: [
                                                      ...
                                                      ElevatedButton.icon(
                                                          onPressed: () {}, icon: Icon(Icons.add), label: Text('추가하기')),
                                                    ],
                                                  ),
                                                  ExpansionTile(
                                                    title: Text('장비 투입'),
